...
SHOP_EMB_DIR  = r"data/extension2/shop_embeddings"
...
CLUST_EMB_DIR = r"data/extension2/cluster_embeddings"
...
print("===================================================")
print(f"=== RESIDUAL HEAD TRAINING STARTS ===")
print("===================================================")
...
loss_path = os.path.join(OUT_DIR, "train_loss_curve.npy")
