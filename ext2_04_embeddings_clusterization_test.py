...
OUT_TEST_FINAL = "data/extension3/shop_embeddings/test_with_clusters.csv"

def assign_outliers_using_train_state(Z, labels, state):
    """
    Forced assignment: samo label == -1 dodijeli najbližem TRAIN centroidu.
    Centroidi/thresholdi dolaze iz TRAIN FINAL klastera.
    """
